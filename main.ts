...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Monke, function (sprite, otherSprite) {
    ...
    info.changeLifeBy(-1)
    console.log("Lost life by monke")
})
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    ...
    scene.cameraShake(4, 500)
    info.changeLifeBy(-1)
    console.log("Lost life by bogey")
})
...
game.onUpdateInterval(5000, function () {
    SPeed = sprites.create(img`
        ...
        1 f f d d d d 1 1 1 1 f . . . . 
        1 c d d d d d d e e 1 d f . . . 
        1 c d f d d f d e e 1 d c . . . 
        1 d d f d d f d e e 1 d c . f f 
        1 d e e d d d d e e 1 c . f e f 
        1 d d d d c d e e e 1 . . f e f 
        1 f c c c d e e e f 1 d d f e f 
        . 1 1 1 1 1 1 1 1 1 e f d f e f 
        ...
        . f f f f f f f . . . f f f . . 
        `, SpriteKind.Monke)
    SPeed.setPosition(160, randint(5, 115))
    SPeed.setVelocity(-200, 0)
    console.log("Game update five sec")
})
game.onUpdateInterval(500, function () {
    ...
    console.log("Game update haf of sec")
})
